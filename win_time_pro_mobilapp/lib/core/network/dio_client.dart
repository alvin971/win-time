...
class DioClient {
  ...
  /// Définit le token immédiatement dans les headers (complément du storage interceptor)
  void setAuthToken(String token) {
    _dio.options.headers[ApiConstants.authHeader] = 'Bearer $token';
  }

  /// Supprime le token des headers (à appeler au logout)
  void clearAuthToken() {
